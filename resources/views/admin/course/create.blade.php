<x-admin.layout>
    <x-slot:title>Create New Course</x-slot:title>
            ...
            <div class="px-4 py-5 sm:p-6">
                <div class="mb-6">
                    <div class="flex items-center justify-between">
                        <h2 class="text-lg font-medium text-gray-900 dark:text-white">Create New Course</h2>
               ...
               file:text-sm cursor-pointer file:font-semibold
               ...
               dark:file:bg-blue-500 dark:hover:file:bg-blue-600">
                            ...
                            <template x-if="previewUrl">
                                <img :src="previewUrl" alt="Preview"
                                    class="h-32 rounded shadow-md object-cover border mt-2" />
                            </template>
                    ...
                    <div>
                        ...
                        <select name="instructor_id" id="instructor_id" required
                            class="mt-1 block w-full rounded-md pl-3 py-2.5 bg-white dark:bg-gray-700 text-gray-900 dark:text-white ring-1 ring-inset ring-gray-300 dark:ring-gray-600 focus:ring-2 focus:ring-blue-600 sm:text-sm">
                            <option value="">Select instructor</option>
                            @foreach (App\Models\User::all() as $user)
                                <option value="{{ $user->id }}"
                                    {{ old('instructor_id') == $user->id ? 'selected' : '' }}>
                    ...
                    <div>
                        <label for="short_description"
                            class="block text-sm font-medium pl-3text-gray-700 dark:text-gray-300">Short Description</label>
                        <textarea name="short_description" id="short_description" rows="3"
                            class="mt-1 block w-full rounded-md bg-white py-2 dark:bg-gray-700 text-gray-900 dark:text-white ring-1 ring-inset pl-3 ring-gray-300 dark:ring-gray-600 focus:ring-2 focus:ring-blue-600 sm:text-sm">{{ old('short_description') }}</textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div class="flex items-center">
                            ...
                            <label for="is_published"
                                class="ml-2 block text-sm text-gray-700 dark:text-gray-300">Publish Course</label>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="is_featured"
                                class="ml-2 block text-sm text-gray-700 dark:text-gray-300">Featured</label>
                        </div>
                    </div>
