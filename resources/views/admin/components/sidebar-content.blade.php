            ...
            <ul role="list" class="-mx-2 space-y-1">
                ...
                <li>
                    <a href="{{ route('admin.users.index') }}"
                        ...
                        <span
                            ...
                            class="transition-opacity duration-300">Users</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ route('admin.categories.index') }}"
                        ...
                        :class="{ 'justify-center': {{ $collapsed ? 'true' : 'collapsed' }} }">
                        <x-heroicon-o-rectangle-stack class="h-6 w-6 shrink-0" />
                        <span
                            :class="{
                                'opacity-0 hidden': {{ $collapsed ? 'true' : 'collapsed' }},
                                'opacity-100': !
                            ...
                            class="transition-opacity duration-300">Categories</span>
                    </a>
                </li>
                <li>
