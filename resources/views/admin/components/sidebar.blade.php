<!-- Sidebar -->
<div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:flex-col" x-data="{
    open: false,
    ...
    <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 transition-all duration-300"
        ...
        <div class="flex h-16 shrink-0 items-center"
            ...
            <span class="ml-3 text-white text-lg font-semibold transition-all duration-300"
                :class="{ 'hidden': collapsed }">Learnity</span>
        </div>

        <!-- Toggle button -->
        <button @click="toggleSidebar"
            class="flex items-center justify-center rounded-md text-gray-400 hover:text-white self-end cursor-pointer">
        ...
        <x-admin.sidebar-content :collapsed="false" />
    </div>
</div>
...
<div class="lg:hidden" x-data="{ open: false }">
    ...
    <div x-show="open" x-transition:enter="transition-opacity ease-linear duration-300"
        ...
        x-transition:leave-end="opacity-0" class="relative z-50 lg:hidden">
        ...
        <div class="fixed inset-0 flex">
            <div x-show="open" x-transition:enter="transition ease-in-out duration-300 transform"
                ...
                <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4">
                    ...
                    <x-admin.sidebar-content :collapsed="false" :mobile="true" />
                </div>
            </div>
        </div>
    </div>
