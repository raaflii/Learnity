<x-admin.layout>
    <x-slot:title>Create Course Category</x-slot:title>
            ...
            <div class="px-4 py-5 sm:p-6">
                <div class="mb-6">
                    <div class="flex items-center justify-between">
                        <h2 class="text-lg font-medium text-gray-900 dark:text-white">Create Course Category</h2>
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        Fill in the details to add a new course category.
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('admin.categories.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea name="description" id="description" rows="4"
                                class="block w-full rounded-md border-0 py-2 pl-3 text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 bg-white dark:bg-gray-700 @error('description') ring-red-500 @enderror">{{ old('description') }}</textarea>
                        </div>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex items-center">
                            {{-- Hidden input agar nilai dikirim sebagai false jika tidak dicentang --}}
