<x-pengajar.layout>
    <x-slot:title>Create New Topic for {{ $course->title }}</x-slot:title>
            ...
            <div class="px-4 py-5 sm:p-6">
                <div class="mb-6">
                    <div class="flex items-center justify-between">
                        <h2 class="text-lg font-medium text-gray-900 dark:text-white">Create New Topic</h2>
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        Fill in the information below to add a new topic to this course.
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('pengajar.courses.topics.store', $course) }}" class="space-y-6">
                    @csrf
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="is_published"
                            class="ml-2 block text-sm text-gray-700 dark:text-gray-300">Publish Topic</label>
                    </div>
